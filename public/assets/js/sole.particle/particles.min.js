...
var Particles = function(e, t) {
    ...
    n.prototype._initializeCanvas = function() {
        ...
        o.element.offsetParent && "BODY" === o.element.offsetParent.nodeName ? o.element.height = e.innerHeight * o.ratio : o.element.height = o.element.offsetParent ? o.element.offsetParent.clientHeight * o.ratio : o.element.clientHeight * o.ratio,
    ...
    n.prototype._checkResponsive = function() {
        var t, n = this, i = !1, o = e.innerWidth;
    ...
    n.prototype._resize = function() {
        ...
        t.element.offsetParent && "BODY" === t.element.offsetParent.nodeName ? t.element.height = e.innerHeight * t.ratio : t.element.height = t.element.offsetParent ? t.element.offsetParent.clientHeight * t.ratio : t.element.clientHeight * t.ratio,
    ...
    n.prototype._draw = function() {
        ...
        t.options.connectParticles && (s.sort(o),
        t._updateEdges())
    }
    ,
    n.prototype._updateEdges = function() {
        for (var e = this, t = e.options.minDistance, n = Math.sqrt, i = Math.abs, o = e.storage, r = o.length, a = 0; a < r; a++)
            for (var s = o[a], l = a + 1; l < r; l++) {
                var c, f = o[l], p = s.x - f.x, h = s.y - f.y;
                if (c = n(p * p + h * h),
                i(p) > t)
                    break;
    ...
    e.requestAnimFrame = function() {
        ...
        return t || (this._usingPolyfill = !0,
        function(t) {
