<?php
    ...
    include_once('../../unite/database/dc.php');
    ...
    include_once('../../unite/file handler/file.php');
    include_once('../../public/load.php');
    include_once('../../unite/assets loader/auto.php');
    include_once('../../unite/route/route.php');
    ...
    for ($i=0; $i < count($conf); $i++) { 
        if(explode('=',$conf[$i])[0]=="Extension"){
            if(file_exists('../../unite/libs/'.explode('=',$conf[$i])[1].'/loader.php')){
                ...
                echo "<b>Library Inclusion Failed: </b>library <b>".explode('=',$conf[$i])[1]."</b> or <b>loader.php </b> file can't be found in ./unite/libs/<br>";
            }
        }
    }
    class Extend_Route{
