<?php
    ...
    class AdminBillingRecordSort{
        ...
        public static function show(Request $request){
            ...
            if($request->sortby == "start"){
                $billingperiods = DB::all($billingperiod,'id','asc');
                ...
                foreach($billingperiods as $bp){
                    if($bp['status'] == "COMPLETE"){
                        array_push($billingperiodtemp,$bp);
                    }else{
                        array_unshift($billingperiodtemp,$bp);
                    }
                }
                Data::json_response($billingperiodtemp);
            }
        }
